...
import com.example.capstone_healthycare.databinding.ActivityStatsBinding
import com.example.capstone_healthycare.helpers.SqliteHelper
import com.example.capstone_healthycare.utils.AppUtils
import com.example.capstone_healthycare.utils.ChartXValueFormatter
...
class StatsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!entries.isEmpty()) {
            ...
            dataSet.color = ContextCompat.getColor(this, R.color.colorBlueDark)
